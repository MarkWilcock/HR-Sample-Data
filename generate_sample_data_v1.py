...
def generate_leave_date(join_date) -> date | None:
    max_leave_date = join_date + relativedelta(years=20)
...
column_names = ["First Name", "Last Name", "Gender", "Grade Key", "FTE", "Birth Date", "Join Date", "Leave Date"]
